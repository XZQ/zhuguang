...
| 工程声明必须可复现 | 自动审批、强因果诊断与云上能力缺少对应运行证据 | pending/timeout、Top-K + 证据缺口、制品 provenance，并拆分“本地已验证”和“外部待验证” | 72 项测试、Worker checksum、事实 JSON |
...
- 仓库已验证：有状态核心、六场景、6 个 P0 Skill、12+3 MCP、Worker ZIP/provenance、72 项测试、消融、指挥台和 HTML/PDF。
