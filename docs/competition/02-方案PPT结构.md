...
- 全量发现 112 项自动化测试：110 项通过，2 项 PolarDB 条件集成测试因无外部实例跳过。
...
| 工程声明必须可复现 | 自动审批、强因果诊断与云上能力缺少对应运行证据 | pending/timeout、Top-K + 证据缺口、制品 provenance，并拆分“本地已验证”和“外部待验证” | 112 项测试、Worker checksum、事实 JSON |
...
- 仓库已验证：有状态核心、六场景、6 个 P0 Skill、12+3 MCP、Worker ZIP/provenance、112 项测试、协调生命周期、消融、指挥台和当前 Markdown/HTML。既有 PDF 保留为历史版本。
