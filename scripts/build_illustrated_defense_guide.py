#!/usr/bin/env python3
"""Build Comprehensive Illustrated Defense Guide in Markdown, HTML and PDF formats."""
...
MD_PATH = ROOT / "docs" / "competition" / "11-2026-GOAI复赛答辩图文全景手册-逐光队.md"
HTML_PATH = ROOT / "dist" / "delivery-portal" / "defense-guide-illustrated.html"
PDF_PATH = ROOT / "dist" / "delivery-portal" / "2026-GOAI复赛答辩图文全景手册-逐光队.pdf"
DOCS_PDF_PATH = ROOT / "docs" / "competition" / "2026-GOAI复赛答辩图文全景手册-逐光队.pdf"

MD_CONTENT = """# 2026 GOAI 赛道一 (Agent Infra) 复赛答辩图文全景手册
...
<head>
  <meta charset="UTF-8">
  <title>2026 GOAI 复赛答辩图文全景手册 · 逐光队</title>
  <style>
    @page {
      size: A4;
...
def generate():
    ...
    # Build HTML with parsed tables, blockquotes, code blocks, etc.
    body_html = ""
    ...
    for line in lines:
        ...
        if line.startswith("# "):
            ...
            body_html += "<hr style='border:none; border-top:1px solid #e2e8f0; margin:14px 0;'>\n"
        elif line.startswith("- "):
