...
<title>VeriAgent｜逐光队 · 2026 GOAI Agent Infra 全国总决赛官方评审与演示指挥中心</title>
<meta name="description" content="2026 世界人工智能开源大赛 (GOAI) 赛道一 Agent Infra 全国总决赛作品：VeriAgent（逐光）面向物理实体流程的可验证多智能体运行时官方评审与演示指挥中心。基于三大物理公理与反自验机制构建物理-数字确定性闭环。">
...
<div class="shell">
  ...
  <header class="header-bar">
    <div class="brand-group">
      ...
      <div class="brand-titles">
        <h1>VeriAgent｜面向物理实体流程的可验证多智能体运行时 <span style="font-size:13px; font-weight:400; color:var(--cyan);">(逐光队 · GOAI 赛道一全国 15 强)</span></h1>
        <div class="sub">通用运行时内核 (General-Purpose Kernel) · 物理-数字三大不可逆公理 · 跨行业基准测试矩阵 (Universal Benchmark Matrix)</div>
      </div>
    </div>
  ...
  <div class="match-banner">
    <div class="match-info">
      ...
      <div class="match-tag">系统全称：<b>VeriAgent｜面向物理实体流程的可验证多智能体运行时</b></div>
      <div class="match-tag">极限基准：<b>Reference Benchmark 01 · 连锁高敏冷链 512 台设备实跑</b></div>
  ...
  <!-- Universal Benchmark Matrix Banner -->
  <div class="benchmark-matrix-bar" style="background: linear-gradient(135deg, rgba(15,23,42,0.95) 0%, rgba(30,41,59,0.9) 100%); border: 1.5px solid rgba(56,189,248,0.35); border-radius: 12px; padding: 16px 20px; margin-bottom: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.4);">
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px; margin-bottom:12px;">
      <div style="display:flex; align-items:center; gap:10px;">
        <span style="font-size:16px;">🌐</span>
        <b style="color:#f8fafc; font-size:14px; letter-spacing:0.02em;">三大行业基准压力测试矩阵 (Universal Benchmark Matrix)</b>
        <span style="background:rgba(56,189,248,0.2); color:#38bdf8; font-size:11px; padding:2px 8px; border-radius:4px; font-weight:700; border:1px solid rgba(56,189,248,0.4);">内核代码 100% 通用 · 仅替换 Profile DSL 配置</span>
      </div>
      <span style="font-size:11.5px; color:#94a3b8; font-family:var(--font-mono);">
        三大物理公理：状态不对称 ✕ 执行不可逆 ✕ 反自验闭环
      </span>
    </div>
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:12px;">
      <div style="background:rgba(2,132,199,0.1); border:1px solid rgba(56,189,248,0.3); border-radius:8px; padding:10px 14px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
          <b style="color:#38bdf8; font-size:12.5px;">基准 01 · 零售高敏冷链</b>
          <span style="font-size:10px; background:#0284c7; color:#fff; padding:1px 6px; border-radius:3px; font-weight:700;">512 台设备实跑基准</span>
        </div>
        <div style="font-size:11.5px; color:#cbd5e1; line-height:1.5;">
          • <b>资产定损</b>：Arrhenius 微生物动力学时间积分<br>
          • <b>数字熔断</b>：500ms 锁定 POS 结算与外卖库存<br>
          • <b>反自验验真</b>：冷柜恢复 4.8°C 但鲜奶超温变质，<b>Auditor 阻断放行</b>
        </div>
      </div>
      <div style="background:rgba(5,150,105,0.1); border:1px solid rgba(16,185,129,0.3); border-radius:8px; padding:10px 14px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
          <b style="color:#34d399; font-size:12.5px;">基准 02 · 生物医药温控</b>
          <span style="font-size:10px; background:#059669; color:#fff; padding:1px 6px; border-radius:3px; font-weight:700;">2~8°C GSP/GMP</span>
        </div>
        <div style="font-size:11.5px; color:#cbd5e1; line-height:1.5;">
          • <b>资产定损</b>：大分子活性变性失效应力积分<br>
          • <b>数字熔断</b>：即刻锁定 WMS 医药仓储出库门禁<br>
          • <b>反自验验真</b>：库温恢复但胶体已破乳，<b>Auditor 一票否决出库</b>
        </div>
      </div>
      <div style="background:rgba(124,58,237,0.1); border:1px solid rgba(167,139,250,0.3); border-radius:8px; padding:10px 14px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
          <b style="color:#c4b5fd; font-size:12.5px;">基准 03 · 智算机房 HPC</b>
          <span style="font-size:10px; background:#7c3aed; color:#fff; padding:1px 6px; border-radius:3px; font-weight:700;">40kW 液冷热失控</span>
        </div>
        <div style="font-size:11.5px; color:#cbd5e1; line-height:1.5;">
          • <b>资产定损</b>：GPU 芯片结温与热阻热容 RC 预测<br>
          • <b>数字熔断</b>：向 Slurm/K8s 下发 Pod 算力无损热迁移<br>
          • <b>反自验验真</b>：水温达标但 ECC 校验错误，<b>Auditor 强制回滚</b>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="portal-footer">
    <div>2026 世界人工智能开源大赛 (GOAI) · 赛道一 Agent Infra · 参赛队伍：逐光（第 3 组｜第 13 队）· 作品：VeriAgent（面向物理实体流程的可验证多智能体运行时）</div>
    <div>代码开源：<a href="https://github.com/XZQ/zhuguang" target="_blank">XZQ/zhuguang</a></div>
  </footer>
</div>
